...
const makePair = (overrides: Partial<KeyValuePair> = {}): KeyValuePair => ({
  id: 'test-id-1',
  key: 'Content-Type',
...
describe('KeyValueTable', () => {
  describe('Rendering', () => {
    it('renders empty table (no pairs) with "+ Add" button', () => {
      ...
      render(<KeyValueTable pairs={[]} onChange={onChange} />);
    ...
    it("renders a pair's key and value as input values", () => {
      const onChange = vi.fn();
      const pair = makePair();
      render(<KeyValueTable pairs={[pair]} onChange={onChange} />);
    ...
    it('renders multiple pairs', () => {
      ...
      render(<KeyValueTable pairs={pairs} onChange={onChange} />);
