...
export function ResponseViewer() {
  ...
  return (
    <div className="flex flex-col h-full border-t border-gray-800">
      ...
      <Tabs.Root defaultValue="body" className="flex flex-col flex-1 overflow-hidden">
        <Tabs.List className="flex items-center border-b border-gray-800 bg-transparent shrink-0">
        ...
        <Tabs.Content value="body" className="flex-1 h-full overflow-hidden">
          <ResponseBody body={response.body} headers={response.headers} />
        </Tabs.Content>

        <Tabs.Content value="headers" className="flex-1 h-full overflow-auto">
